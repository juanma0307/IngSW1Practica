...
public class UadyVirtualLoginTest{
  ...
  public void testCasoDePruebaFallidaUady() throws Exception {
    ...
    driver.findElement(By.id("username")).sendKeys("adsw");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("adwdw");
    driver.findElement(By.id("loginbtn")).click();
    driver.findElement(By.xpath("//section[@id='region-main']/div/div/div/div/div")).click();
